    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissionMappingTb", x => new { x.PermissionsPermissionId, x.RolesRoleId });
                    table.ForeignKey(
                        name: "FK_RolePermissionMappingTb_PermissionTb_PermissionsPermissionId",
                        column: x => x.PermissionsPermissionId,
                        principalTable: "PermissionTb",
                        principalColumn: "PermissionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermissionMappingTb_RoleTb_RolesRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissionMappingTb_RolesRoleId",
